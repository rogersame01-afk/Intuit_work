...
INSERT INTO cgan_ustax_ws.saves_cch_000_braze_sms
SELECT *, CURRENT_DATE AS last_ingested_date
FROM cgan_ustax_ws.saves_cch_000_braze_sms_stg AS stg
WHERE NOT EXISTS (
    SELECT 1
    FROM cgan_ustax_ws.saves_cch_000_braze_sms AS tgt
