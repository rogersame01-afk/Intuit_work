...
# specify sheet id
sheet_id = '6696111305609092' # your_sheet_id
...
spark_df.write.mode('overwrite').format('parquet').saveAsTable('cgan_ustax_ws.Saves_Smartsheet_Outreach_Campaigns_Roadmap')
