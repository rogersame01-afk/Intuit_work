/*DROP TABLE IF EXISTS cgan_ustax_ws.saves_cch_003_append_biztax_stg1;
CREATE TABLE cgan_ustax_ws.saves_cch_003_append_biztax_stg1 as
...
from cgan_ustax_ws.saves_cch_002_metrics_biztax as base
...
DROP TABLE IF EXISTS cgan_ustax_ws.saves_cch_003_append_biztax_stg;
CREATE TABLE cgan_ustax_ws.saves_cch_003_append_biztax_stg as
select distinct base.*
, coalesce(reauth.flag_reauth, 0) as flag_reauth 
from cgan_ustax_ws.saves_cch_003_append_biztax_stg1 as base
...
DROP TABLE IF EXISTS cgan_ustax_ws.saves_cch_003_append_biztax;
CREATE TABLE cgan_ustax_ws.saves_cch_003_append_biztax as
select * from cgan_ustax_ws.saves_cch_003_append_biztax_historical --historical
union 
select * from cgan_ustax_ws.saves_cch_003_append_biztax_stg --current tax year
;*/
