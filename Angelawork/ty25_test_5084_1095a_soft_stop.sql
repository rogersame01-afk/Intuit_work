...
DROP TABLE IF EXISTS cgan_general_published.ty25_5084_users;
CREATE TABLE cgan_general_published.ty25_5084_users as 
with test as (
...
DROP TABLE IF EXISTS cgan_general_published.ty25_5084_users_auth_level;
CREATE TABLE cgan_general_published.ty25_5084_users_auth_level as 
    select
          auth_id                                        
    ...
    from cgan_general_published.ty25_5084_users
    group by 1,2,3,4,5
...
DROP TABLE IF EXISTS cgan_general_published.ty25_5084;
CREATE TABLE cgan_general_published.ty25_5084 as 
SELECT
  experiment_id,
  condition,
  metric,
  ...
  COUNT(*) AS trials
FROM cgan_general_published.ty25_5084_users_auth_level
GROUP BY 1,2,3,4
ORDER BY 1,2,3,4
;
