drop table if exists cgan_ustax_ws.aw_test_ty25_5177_7216_gdc_muc_consent_weekend;
create table cgan_ustax_ws.aw_test_ty25_5177_7216_gdc_muc_consent_weekend as
with test as (
  select a.test_name
    , a.auth_id
    , a.pseudonym_id
  ...
  where a.first_assignment_date_pt >= date('2026-04-04')
),
...
consent as (
  ...
  from cgan_ustax_published.Consents_by_AUTH_ty25_ty24
  where tax_year = 2025
),
